  ...
  return(
    <div className="container about_content shadow">
      ...
      <form onSubmit={InsertData}>
        ...
        <div className="mb-3">
          <input className="form-control" type="file" name="rep1_img" title="rep1_img" onChange={handleRep1FileChange} />
        </div>
        <div className="mb-3">
          <input type="text" className="form-control" name="rep1_desc" placeholder="img1 description" onChange={handleChange}/>
        </div>
        <div className="mb-3">
          <input className="form-control" type="file" name="rep2_img" title="rep2_img" onChange={handleRep2FileChange}/>
        </div>
        <div className="mb-3">
